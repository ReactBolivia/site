...
const Surveyquestions = props => {
  ...
  return (
    ...
    {theme => (
      <React.Fragment>
      <span>
      Por favor llena esta encuesta sobre el evento Reac Bolivia 2019.
      </span>
      <Divider />
      <div className="form">
      <Form
      ...
      <span>
        <h3 style={{ margin: "0 0 3px 0" }}>1. Califica del 1 (muy malo) a 5 (excelente) los siguientes aspectos:</h3>
      </span>
      ...
      <FormItem label="¿Por qué medio te enteraste del meetup 'React And Data?'" style={{ width:"100%", padding: "3px"}}>
      ...
      <FormItem label="¿Cuál fue la charla que más te agradó del meetup 'React And Data'?" style={{ width: "100%", padding: "3px" }}>
      {getFieldDecorator("pregunta_8", {
      })(<Checkbox.Group name="pregunta_8" style={{ width: '100%' }}>
      <Row>
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 1">El Poder Del dato</Checkbox></Col><br />
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 2">Web Components fantásticos y donde encontrarlos</Checkbox></Col><br />
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 3">Acceso a la Información y Datos Abiertos</Checkbox></Col><br />
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 4">Entre icebergs, ML y el Titanic</Checkbox></Col><br />
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 5">Usando React Native para el desarrollo de apps móviles</Checkbox></Col><br />
      <Col span={8} style={{ width: '100%' }}><Checkbox value="Mesa 6">How To Compete on Data Science</Checkbox></Col><br />
      </Row>
      </Checkbox.Group>)}

      </FormItem>

      <FormItem label="¿Qué temática te gustaría incluir en los próximos eventos de React Bolivia?" style={{ width: "100%", padding: "3px" }}>
      ...
      <span>
      <h3 style={{ margin: "0 0 3px 0" }}>2. Califica del 1 (Nada) a 5 (Experto) el siguiente aspecto:</h3>
      </span>
      <FormItem label="¿Qué tanto dominas React?" style={{ width: "100%", padding: "3px" }}>
      ...
      <span>
      <h3 style={{ margin: "0 0 3px 0" }}>3. Califica del 1(No me interesa) a 5 (Me interesa mucho), el siguiente aspecto:</h3>
      </span>
      <FormItem label="¿Estarías interesado en tomar un curso de React impartido por la comunidad React Bolivia?" style={{ width: "100%", padding: "3px" }}>
      ...
      <FormItem label="Queremos mejorar la comunidad de React Bolivia en sus próximos eventos, ¿tienes algún comentario, crítica o sugerencia?" style={{ width: "100%", padding: "3px" }}>
      {getFieldDecorator("pregunta_12", {
      })(<TextArea name="pregunta_12" autosize={{ minRows: 2, maxRows: 6 }} style={{ margin: "0 0 0 0"}}/>)}
